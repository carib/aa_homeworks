...
var _todo_api_util = __webpack_require__(19);
...
//
var fetchTodos = exports.fetchTodos = function fetchTodos(todos) {
  return $.ajax({
    method: 'GET',
    url: '/api/todos'
  });
...
var _todo_actions = __webpack_require__(9);
...
var _thunk = __webpack_require__(81);
...
var initialState = { 2: { id: 2, title: "YO" } };
...
var _todo_list_container = __webpack_require__(77);
...
var _todo_list = __webpack_require__(78);
...
var _todo_form = __webpack_require__(80);
...
var TodoList = function TodoList(props) {
  ...
  var todos = props.todos.map(function (todo, idx) {
...
var TodoForm = function (_React$Component) {
  ...
  _createClass(TodoForm, [{
    ...
    value: function submit(e) {
      e.preventDefault();
      this.props.receiveTodo(Object.assign({}, this.state, { id: (0, _todo_api_util.uniqueId)() }));
      this.setState({ title: '' });
    }
  }, {
    key: 'render',
